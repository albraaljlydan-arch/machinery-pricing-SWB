<script lang="ts">
  // ==========================================================================
  //  ADMIN SHELL — a Shopeers-style light sidebar + topbar chrome, used only
  //  by the admin section. Kept separate from AppShell (shared by every other
  //  role) so this redesign can't change how designer/procurement/accounting/
  //  factory/followup/developer dashboards look.
  // ==========================================================================
