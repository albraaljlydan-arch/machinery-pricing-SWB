...
const dict = {
  ar: {
    ...
    settingsOpen: 'الإعدادات والحساب',
    settingsAccountSection: 'معلومات الحساب',
    settingsAccountHint: 'يدير المصنع هذه البيانات. تواصل معه لتعديل الاسم أو الدور.',
    settingsFullName: 'الاسم الكامل',
    settingsEmail: 'البريد الإلكتروني',
    settingsRole: 'الدور',
    settingsMemberSince: 'تاريخ الانضمام',
    settingsLastSignIn: 'آخر تسجيل دخول',
    settingsSecuritySection: 'الأمان وكلمة المرور',
    settingsSecurityHint: 'لحماية حسابك، أدخل كلمة المرور الحالية قبل تعيين كلمة جديدة.',
    ...
    settingsPasswordRule: 'ثمانية أحرف على الأقل.',
    settingsShowPassword: 'إظهار',
    settingsHidePassword: 'إخفاء',
    settingsChangePasswordBtn: 'تغيير كلمة المرور',
    settingsChangingPassword: 'جارٍ التغيير…',
    settingsPasswordChanged: '✅ تم تغيير كلمة المرور بنجاح.',
    settingsErrShort: 'يجب أن تتكوّن كلمة المرور الجديدة من ثمانية أحرف على الأقل.',
    settingsErrMismatch: 'كلمتا المرور الجديدتان غير متطابقتين.',
    settingsErrSame: 'يجب أن تختلف كلمة المرور الجديدة عن الحالية.',
    settingsErrCurrent: 'كلمة المرور الحالية غير صحيحة.',
    settingsErrGeneric: 'تعذّر تغيير كلمة المرور: ',
    ...
    settingsSessionSection: 'الجلسة',
    settingsSessionHint: 'سجّل الخروج من هذا الجهاز، أو من جميع الأجهزة إذا كنت تشك في استخدام حسابك من مكان آخر.',
    settingsSignOutAll: 'تسجيل الخروج من جميع الأجهزة',
    settingsSignOutAllConfirm: 'سيُسجَّل خروجك من جميع الأجهزة، ومنها هذا الجهاز. هل تريد المتابعة؟',
    ...
    colMaterial: 'المادة',
    priceTabSheet: 'الصاج',
    priceTabProfile: 'البروفيلات',
    priceTabMill: 'الميّال',
    priceTabPipe: 'البواري والبوش',
    priceTabSquare: 'التربيعات والبلاطات',
    pricesEditorHint: 'عدّل سعر الجملة والمفرّق لكل مادة في كل تبويب. تستخدم الحاسبة سعر التبويب نفسه، ويصل التعديل إلى كل المصممين فور الحفظ.',
    pricesReadonlyHint: 'عرض للقراءة فقط. يحدّث حساب المشتريات هذه الأسعار، وتستخدمها الحاسبة تلقائيًا.',
    pricesUnsaved: 'تعديلات غير محفوظة',
    pricesDiscard: 'تراجع عن التعديلات',
    pricesInvalid: 'أدخل أسعارًا صحيحة (صفر أو أكثر) قبل الحفظ.',
    pricesSetupRequired: 'جدول أسعار الأنواع غير موجود بعد. شغّل ملف supabase-material-category-prices.sql في Supabase.',
    pricesLoadError: 'تعذّر تحميل الأسعار: ',
    pricesSaveError: 'تعذّر حفظ الأسعار: ',
    pricesLastUpdated: 'آخر تحديث',
    offlineSavedLocally: 'الاتصال ضعيف، فحُفظت التعديلات على هذا الجهاز، وستُرفع تلقائيًا عند عودة الاتصال.',
    offlineSynced: '✅ رُفعت التعديلات المحفوظة على الجهاز: {names}',
    offlineSyncLocked: 'لم تُرفع تعديلات المشروع {names} لأنه لم يعد مسودة (أُرسل إلى المدير).',
    offlinePendingNotice: 'لهذا المشروع تعديلات محفوظة على هذا الجهاز لم تُرفع بعد، وستُرفع تلقائيًا عند عودة الاتصال.',
    leftWithoutSaving: 'خرجت من المشروع دون حفظ التعديلات.',
    saveNowAction: 'حفظ',
    submitOfflineError: 'لا يمكن الإرسال إلى المدير دون اتصال بالإنترنت. احفظ المسودة وأعد المحاولة عند عودة الاتصال.',
    projectNoLongerEditable: 'لم يُحفظ المشروع لأنه لم يعد مسودة.',
    sheetBandUpTo: 'حتى {b} مم',
    sheetBandRange: 'من {a} إلى {b} مم',
    sheetBandAbove: 'أكثر من {a} مم',
    sheetBandAll: 'كل السماكات',
    sheetBandsSettings: 'إعدادات السماكات',
    sheetBandsSettingsHint: 'قسّم أسعار الصاج حسب السماكة. كل باقة تشمل السماكات الأكبر من حدّ الباقة السابقة حتى حدّها، والباقة الأخيرة تشمل كل ما هو أكبر. الأسعار بالدولار.',
    sheetBandN: 'الباقة رقم {n}',
    sheetBandLimitLabel: 'حتى (مم)',
    sheetBandCovers: 'تشمل: {range}',
    sheetBandAdd: 'إضافة باقة',
    sheetBandDelete: 'حذف الباقة',
    sheetBandsSave: 'حفظ الباقات',
    sheetBandsSaved: '✅ تم حفظ باقات السماكة.',
    sheetBandsInvalid: 'حدود الباقات يجب أن تكون أرقامًا أكبر من صفر وغير مكررة.',
    sheetBandsSaveError: 'تعذّر حفظ الباقات: ',
    sheetBandsSaveFirst: 'احفظ تعديلات الأسعار أو تراجع عنها أولًا.',
    sheetBandsNewHint: 'الباقة الجديدة تبدأ بأسعار الباقة التي تُقسَم منها، ثم تعدّلها من جدول الأسعار.',
    sheetBandsSetupRequired: 'باقات السماكة غير مفعّلة بعد، فسعر الصاج واحد لكل السماكات. شغّل ملف supabase-sheet-thickness-bands.sql في Supabase لتفعيلها.',
    ...
    renderImageLabel: '🖼️ الصورة التصميمية للمشروع',
    renderImageHint: 'ارفع صورة تصميمية واضحة للمشروع بدلًا من إرسال ملف المجسّم، وهي مطلوبة قبل الإرسال إلى المدير.',
    ...
    needImageBeforeSubmit: '⚠️ ارفع الصورة التصميمية للمشروع قبل إرساله إلى المدير.',
  ...
  en: {
    ...
    settingsOpen: 'Settings and account',
    settingsAccountSection: 'Account information',
    settingsAccountHint: 'Factory manages these details. Contact them to change your name or role.',
    settingsFullName: 'Full name',
    settingsEmail: 'Email',
    settingsRole: 'Role',
    settingsMemberSince: 'Member since',
    settingsLastSignIn: 'Last sign-in',
    settingsSecuritySection: 'Security and password',
    settingsSecurityHint: 'To protect your account, enter your current password before setting a new one.',
    settingsCurrentPassword: 'Current password',
    settingsNewPassword: 'New password',
    settingsConfirmPassword: 'Confirm new password',
    settingsPasswordRule: 'At least 8 characters.',
    settingsShowPassword: 'Show',
    settingsHidePassword: 'Hide',
    ...
    settingsErrShort: 'The new password must be at least 8 characters.',
    settingsErrMismatch: 'The new passwords do not match.',
    settingsErrSame: 'The new password must be different from the current one.',
    settingsErrCurrent: 'The current password is incorrect.',
    settingsErrGeneric: 'Could not change password: ',
    ...
    settingsSessionHint: 'Sign out of this device, or of every device if you suspect your account is being used elsewhere.',
    settingsSignOutAll: 'Sign out of all devices',
    settingsSignOutAllConfirm: 'You will be signed out of every device, including this one. Continue?',
    homeSection: 'Home',
    loading: 'Loading…',
    openAction: 'Open',
    save: 'Save',
    ...
    priceTabSheet: 'Sheet Metal',
    priceTabProfile: 'Profiles & Tubes',
    priceTabMill: 'Mill (Round)',
    priceTabPipe: 'Pipes & Bushings',
    priceTabSquare: 'Square & Blocks',
    pricesEditorHint: 'Set the wholesale and retail price of each material in every tab. The calculator uses the matching tab’s price, and changes reach every designer as soon as you save.',
    pricesReadonlyHint: 'Read-only. Procurement maintains these prices, and the calculator uses them automatically.',
    pricesUnsaved: 'Unsaved changes',
    pricesDiscard: 'Discard changes',
    pricesInvalid: 'Enter valid prices (zero or more) before saving.',
    pricesSetupRequired: 'The category prices table does not exist yet. Run supabase-material-category-prices.sql in Supabase.',
    pricesLoadError: 'Could not load prices: ',
    pricesSaveError: 'Could not save prices: ',
    pricesLastUpdated: 'Last updated',
    offlineSavedLocally: 'Weak connection: your changes were saved on this device and will upload automatically when the connection returns.',
    offlineSynced: '✅ Changes saved on this device were uploaded: {names}',
    offlineSyncLocked: 'Changes to {names} were not uploaded because it is no longer a draft (it was submitted to Admin).',
    offlinePendingNotice: 'This project has changes saved on this device that have not been uploaded yet; they will upload automatically when the connection returns.',
    leftWithoutSaving: 'You left the project without saving your changes.',
    saveNowAction: 'Save',
    submitOfflineError: 'You cannot submit to Admin without an internet connection. Save the draft and try again when the connection returns.',
    projectNoLongerEditable: 'The project was not saved because it is no longer a draft.',
    sheetBandUpTo: 'Up to {b} mm',
    sheetBandRange: '{a} – {b} mm',
    sheetBandAbove: 'Above {a} mm',
    sheetBandAll: 'All thicknesses',
    sheetBandsSettings: 'Thickness bands',
    sheetBandsSettingsHint: 'Split sheet prices by thickness. Each band covers thicknesses above the previous band’s limit up to its own; the last band covers everything thicker. Prices are in USD.',
    sheetBandN: 'Band {n}',
    sheetBandLimitLabel: 'Up to (mm)',
    sheetBandCovers: 'Covers: {range}',
    sheetBandAdd: 'Add band',
    sheetBandDelete: 'Delete band',
    sheetBandsSave: 'Save bands',
    sheetBandsSaved: '✅ Thickness bands saved.',
    sheetBandsInvalid: 'Band limits must be numbers greater than zero, with no duplicates.',
    sheetBandsSaveError: 'Could not save bands: ',
    sheetBandsSaveFirst: 'Save or discard your price changes first.',
    sheetBandsNewHint: 'A new band starts with the prices of the band it splits; adjust them in the price table.',
    sheetBandsSetupRequired: 'Thickness bands are not enabled yet, so one sheet price applies to every thickness. Run supabase-sheet-thickness-bands.sql in Supabase to enable them.',
